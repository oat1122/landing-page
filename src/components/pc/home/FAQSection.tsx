    ...
    <section className="py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="ข้อสงสัยเกี่ยวกับการผลิตเสื้อ?"
          description="รวมคำถามยอดฮิตจากลูกค้าของเรา หากมีข้อสงสัยเพิ่มเติม สามารถทักแชทสอบถามฝ่ายขายได้ตลอดเวลาครับ"
        />
            ...
            >
              ...
              <div
                className={`transition-all duration-300 ease-in-out ${
                  isOpen(index) ? "max-h-48 opacity-100" : "max-h-0 opacity-0"
                }`}
              >
